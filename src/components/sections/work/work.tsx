...
export default component$((props: IWork) => {
	return (
		...
		<h1 class='right-panel-header'>Work</h1>
			<p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Rem voluptatibus totam magni perspiciatis cumque vel repellat deleniti ut, temporibus maxime deserunt. Ipsa nemo ipsum temporibus distinctio quas voluptas animi non.</p>
		</article>
		</div>
